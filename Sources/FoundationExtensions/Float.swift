...
public extension Float {
    /// The upper bound on integers a Float can represent accurately (meaning conversion from integer to Float and back again will result in the original integer value).
    ///
